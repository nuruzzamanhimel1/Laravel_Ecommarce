              ...
              <p class="card-text">
                    <div class="table-responsive">
                         <table class="table" id="myTable">
                            <thead class="thead-light">
                              <tr>
                                ...
                                <th scope="col" width="10%">District Name</th>
                                {{-- <th scope="col" width="20%">Catagory description</th> --}}
                                <th scope="col" width="10%"> Division Name</th>
                      ...
                      <a href=" {{ route('admin.district.edit',$district->id) }}" class="btn btn-success"> Edit</a> ||
                                      <a href="#" class="btn btn-danger modal_button" data-toggle="modal" data-target="{{ '#delete_district'.$district->id }}"  >Delete</a>
                                     
                                    </td>

                                                                   <!-- Modal -->
<div class="modal fade" id="{{ 'delete_district'.$district->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
