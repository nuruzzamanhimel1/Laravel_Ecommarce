              ...
              <p class="card-text">
                    <div class="table-responsive">
                      ...
                      <a href="{{ route('admin.division.edit',$division->id) }}" class="btn btn-success"> Edit</a> ||
                                      <a href="#" class="btn btn-danger modal_button" data-toggle="modal" data-target="{{ '#delete_division'.$division->id }}"  >Delete</a>
                                    </td>

                                                                   <!-- Modal -->
<div class="modal fade" id="{{ 'delete_division'.$division->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
